...
const NewEntryScreen = () => {
    ...
    const prefilledPrompt = params.prefilledPrompt as string | undefined;
    ...
    const handleDonePress = () => {
        ...
        const finalTitle = entryText.trim();

        if (!prefilledPrompt && finalTitle.length === 0 && !imageUri) {
            router.back();
            return;
        }
                        ...
                        <View className="flex-1 px-4 pt-2">
                            ...
                            {prefilledPrompt && (
                                <View className='p-2 rounded-lg bg-gray-800 mt-4 mb-2 self-start'>
                                    <Text className='text-white text-sm'>{prefilledPrompt.toUpperCase()}</Text>
                                </View>
                            )}
